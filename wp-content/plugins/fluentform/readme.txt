...
<li>WebHook - Broadcaset your WordPress Forms Submission to any web api endpoint with powerful webhook module.</li>
...
<li>Trello - Create Trello Cards in your broards on form submission</li>
...
* Email delivary fix for multiple emails
